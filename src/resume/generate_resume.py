...
<body>
    ...
    <div>
      <div class="skill-group">
        ...
        <ul>
          ...
          <li>C++, <strong>Reverse Engineering</strong></li>
        </ul>
      </div>
      <div class="skill-group">
        <h3>Web</h3>
        <ul>
          ...
          <li>Django, Flask, SpringBoot, REST APIs</li>
    ...
    <div>
      <div class="skill-group">
        ...
        <ul>
          ...
          <li>Vector Databases, pgvector, Prompt Engineering</li>
          <li>OpenAI, Anthropic, Claude, Gemini, Mistral, Ollama</li>
          <li>FastAPI, gRPC</li>
        </ul>
      </div>
      <div class="skill-group">
        <h3>Tools</h3>
        <ul>
          <li>Cursor, VS Code, Claude</li>
          <li>Xcode, Android Studio, Visual Studio</li>
  ...
  <div class="job">
    ...
    <ul>
      ...
      <li>Contributed bug fixes and feature improvements to hot repositories, including resolving credibility display mismatches, dependency conflicts, and memoization bugs in Rails-based financial dashboards.</li>
